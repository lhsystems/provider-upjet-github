...
| `HostedRunner`                    | `actions`        | `github_actions_hosted_runner`                       |                                                                                                                                                                                                                                                                                                                               |
...
| `CostCenter`                  | `enterprise`   | _manual_                                          | Manages GitHub Enterprise Cost Centers via REST API. Cluster-scoped only.                                                                                                                                                                                                                                                   |
